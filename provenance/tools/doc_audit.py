...
STATUS = {
    ...
    "case01/docs/Governance平台对接说明.md": ("口径待重签", "5002 冻结契约的说明;**「平台只用 5002、不要依赖实时面」这条已被 2026-09-21 的决定(5010 升格为唯一契约)覆盖**;数据/信息边界两节仍有效"),
...
def main():
    ...
    if args.index:
        ...
        out = ["# 文档索引(状态一览)", "",
               "> **状态**:现行 · 由 `tools/doc_audit.py --banner --index` 生成,勿手工大改",
               "> **最后核对**:{}".format(time.strftime("%Y-%m-%d")),
