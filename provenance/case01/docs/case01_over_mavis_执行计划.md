...
> 建立日期：2026-09-16
> 前置事实：引擎侧的本地 HF 提交 `7ae216f` 已直接在 main 上（未走 PR）；本计划 Phase 0 与之相关但独立。
...
> 变更记录（2026-09-16）：原阶段 0（补齐 引擎侧的本地 HF 提交的评审、测试与 CI）**决定不做**。不做项与已知后果见文末。
...
5. 排期冲突：平台侧协作方平台联调配合、引擎侧的 HF 后端、演示视频录制均已确认可后置。

---

## 不做项与已知后果（2026-09-16 决定）

原阶段 0（补齐 引擎侧 HF 提交的流程）不做，以下后果已知并接受：
